 ...
 * resolved to a name through `core/users` (`.scratch/users-read-api/spec.md`,
 * GAP-06) when the viewer holds `USER_MANAGE`; falls back to the raw id
 * otherwise, same as every other unresolved reference.
 *
